package maratonajava.javacore.ZZGconcorrencia.service;

import maratonajava.javacore.ZZGconcorrencia.dominio.Discount;
...
public class StoreServiceWithDiscount {
    ...
    public String applyDiscount(Quote quote) {
        delay();
        double discountValue = quote.getPrice() * (100 - quote.getDiscountCode().getPercentege()) / 100;
